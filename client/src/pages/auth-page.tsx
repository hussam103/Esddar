...
export default function AuthPage() {
  ...
  // قم بالتحقق من تسجيل الدخول في البداية وإعادة التوجيه إلى الصفحة المناسبة حسب صلاحيات المستخدم
  if (isLoggedIn) {
    // إذا كان المستخدم لديه صلاحيات الإدارة، قم بتوجيهه إلى لوحة الإدارة
    if (user.role === 'admin') {
      return <Redirect to="/admin" />;
    }
    // وإلا قم بتوجيهه إلى لوحة التحكم العادية
